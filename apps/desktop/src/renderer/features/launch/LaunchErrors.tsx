...
export const ERROR_MESSAGES: Record<ErrorCode, string> = {
  ...
  MISSION_DRAFT_DISCARD_STALE:
    'The draft changed since the discard preview. Preview it again.',
  MISSION_DRAFT_LIMIT:
    'Twenty drafts are already open. Finish or discard one first.',
  MISSION_DRAFT_NOT_FOUND: 'That mission draft no longer exists.',
  MISSION_DRAFT_SAVE_FAILED:
    'Your draft could not be saved. Nothing has been discarded.',
  MISSION_DRAFT_STALE:
    'This draft was saved elsewhere. Reload it before continuing.',
