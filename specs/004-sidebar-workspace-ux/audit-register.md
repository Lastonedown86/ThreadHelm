...
| A06  | Memory, search, reading, editing, revisions, associations                        | Audit recorded; four proposed findings; UI and independent saved-state/restart proof; matrix gaps explicit                               | [A06 report](audits/a06-memory-functionality.md)             |
...
| Finding | Priority | Proposed improvement                                                                           | Disposition                                    |
| ------- | -------- | ---------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| MEM-001 | High     | Invalidate supersession review after title/body edits; commit the exact newly reviewed content | Proposed; recommended next bounded slice       |
...
| MEM-003 | High     | Preserve selected workspace through guided search                                              | Proposed                                       |
